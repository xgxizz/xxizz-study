...
public class SyncMethodFromDiffObject implements Runnable {
     ...
     * 而由于 myThread1 和 myThread2 是两个不同的对象， 因此 synchronized 锁的对象就不一样， 锁不一样，就起不到互斥的效果。就是说有两把锁lock1 和 lock2
     * lock1 锁住的对象是object1, lock2锁住的对象是object2，lock1锁不住object2,同样，lock2也锁不住object1. 因此对static 变量 count 起不到锁的作用。
     */
}
